...
import com.taha.fittrack.activity.FindActivity;
import com.taha.fittrack.activity.MessagesActivity;
import com.taha.fittrack.activity.OrdersActivity;
import com.taha.fittrack.R;
import com.taha.fittrack.activity.ServiceActivity;
import com.taha.fittrack.activity.ServiceManagerActivity;
import com.taha.fittrack.activity.WelcomeActivity;
import com.taha.fittrack.activity.ConnectionsActivity;
import com.taha.fittrack.activity.DiaryActivity;
import com.taha.fittrack.activity.FoodListActivity;
import com.taha.fittrack.activity.PostActivity;
import com.taha.fittrack.activity.RequestActivity;
import com.taha.fittrack.activity.ViewMessagesActivity;
...
public class ProfileFragment extends Fragment
{
                             ...
                             Bundle savedInstanceState)
    {
        ...
        if(intentPurpose != null && intentPurpose.equals("ViewAnotherUserProfile"))
        {
                ...
                if(dataSnapshot.exists())
                {
                    if(dataSnapshot.hasChild("points"))
                    {
                        ...
                        if(Integer.parseInt(points) < 20)
                        {
                            ...
                            profileBadge.setImageResource(R.drawable.silver_medal_icon);
                        }

                        if(Integer.parseInt(points) >= 20)
                        {
                            profileBadgeLevel.setText("Gold Member");
                            profileBadge.setImageResource(R.drawable.gold_medal_icon);
                        }

                        if(Integer.parseInt(points) >= 50)
                        {
                            profileBadgeLevel.setText("Platinum Member");
                            profileBadge.setImageResource(R.drawable.platinum_medal_icon);
                        }

                        if(Integer.parseInt(points) >= 100)
                        {
                            profileBadgeLevel.setText("Diamond Member");
                            profileBadge.setImageResource(R.drawable.diamond_medal_icon);
                        }
                    }
                }
            }
