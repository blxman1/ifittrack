...
public class SetupActivity extends AppCompatActivity {
    ...
    private androidx.cardview.widget.CardView userBirthdayContainer, userHeightContainer, userWeightContainer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userWeightContainer = (androidx.cardview.widget.CardView) findViewById(R.id.setup_weight_container);
        userHeightContainer = (androidx.cardview.widget.CardView) findViewById(R.id.setup_height_container);
        userBirthdayContainer = (androidx.cardview.widget.CardView) findViewById(R.id.setup_birthday_container);
                ...
                new ActivityResultContracts.StartActivityForResult(), result -> {
                    if (result.getResultCode() == RESULT_OK && result.getData() != null) {
                        ...
                        if (selectedImageUri != null) {
                            ...
                            Picasso.get().load(croppedUserImage).placeholder(R.drawable.default_user_image).into(userImage);
                            imagePick= 1;
                        }
                    }
                });
