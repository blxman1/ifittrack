...
public class GoalsActivity extends AppCompatActivity
{
    ...
    private androidx.cardview.widget.CardView GoalCompleteContainer, GoalDetailsContainer;

    private String currentWeight="", goalWeight="", weeklyGoalWeight="", startWeight, startDate, remainingWeight, cutCalories, goalType="lose";
        ...
        userDatabaseReference.addValueEventListener(new ValueEventListener()
        {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    {
                        goalType = dataSnapshot.child("usergoaltype").getValue().toString();
                    }
                    ...
                    if(!goalWeight.isEmpty())
                    {
                        ...
                        {
                            remainingWeight = String.format(Locale.US,"%.1f",(Double.parseDouble(goalWeight) - Double.parseDouble(currentWeight)));
                        }
                        else
                        {
                    ...
                    weightLossAchievementDatabaseReference.addValueEventListener(new ValueEventListener()
                    {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                        {
                            if(dataSnapshot.exists())
                            {
                                ...
                                {
                                    String goalTypeText = goalType.equals("gain") ? "weight gain" : "weight loss";
                                    GoalTitle.setText("Achievement");
                                    GoalDetailsContainer.setVisibility(View.GONE);
                                    GoalCompleteContainer.setVisibility(View.VISIBLE);
                                    GoalCompleteDetails.setText("Congratulations, You have achieved your previous " + goalTypeText + " goal." +
    ...
    private void PopupSetGoalDialog()
    {
        ...
        final RadioGroup goalTypeRadioGroup = setGoalDialog.findViewById(R.id.set_goal_type_radio_group);
        final RadioButton loseWeightRadio = setGoalDialog.findViewById(R.id.set_goal_lose_weight);
        final RadioButton gainWeightRadio = setGoalDialog.findViewById(R.id.set_goal_gain_weight);
        ...
        if(goalType.equals("gain"))
        {
            gainWeightRadio.setChecked(true);
        }
        else
        {
            loseWeightRadio.setChecked(true);
        }
        ...
        submitBtn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                String DialogWeight, DialogWeeklyWeight, goalType;

                DialogWeight = weightInput.getText().toString();
                DialogWeeklyWeight = weeklyWeightInput.getText().toString();
                boolean isLoseWeight = loseWeightRadio.isChecked();
                goalType = isLoseWeight ? "lose" : "gain";
                ...
                else if(isLoseWeight && Double.parseDouble(DialogWeight) >= (Double.parseDouble(currentWeight)))
                {
                ...
                {
                    error.setText("Goal weight should be larger than current weight.");
                    error.setVisibility(View.VISIBLE);
                }
                ...
                else
                {
                    ...
                    userMap.put("usergoaltype", goalType);
